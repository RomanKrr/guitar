        ...
        <div className='filter-container'>
            ...
            <div className='side'>
                ...
                <div className='button-nav'>
                    ...
                    <select className='sort-button' onChange={() => setCheap(!cheap)}>
                        <option value="cheap-dear">Від дешевих до дорогих</option>
                        <option value="dear-cheap">Від дорогих до дешевих</option>
                    </select>
            ...
            <div className='main-page'>
                <div className='main-page-items'>
                    {products.sort(sortByPrice).map((item, i) => (
